...
- **Sync/async** — filter the board to one sub-team to plan independently (_async_); the task
  list and the Gantt always show each task's overall span across all sub-teams (_sync_).
